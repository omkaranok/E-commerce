...
const VerticalCardProduct = ({category,heading}) => {
  ...
  return (
    <div className='container mx-auto px-4 my-6 relative'>
        ...
        <button  className='bg-white shadow-md rounded-full p-1 absolue left-0 text-lg hidden md:block absolute' onClick={scrollLeft}><FaAngleLeft/></button>
        <button className='bg-white shadow-md rounded-full p-1 absolute right-0 text-lg hidden md:block absolute' onClick={scrollRight}><FaAngleRight/></button>
            {
                        ...
                        return(
                            <Link to={"product/"+product?._id} className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow-md ' >
                                ...
                                <div className='p-4 grid gap-3'>
                                    ...
                                    <div className='flex gap-3'>
                                        <p className='text-red font-medium'>{ displayINRCurrency(product?.sellingPrice)}</p>
