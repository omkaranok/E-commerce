...
import CategoryWiseProductDisplay from '../componenets/CategoryWiseProductDisplay';
            ...
            {/**Product details */}
            {
                loading?(
                    <div className='grid gap-1 w-full'>
                        ...
                        <p className='capitalize bg-slate-200 min-w-[100px] animate-pulse h-6 text-slate-400 w-full lg:h-8'></p>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <div className='flex items-center gap-3 my-2'>
                                ...
                                <button className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px] text-white bg-red-600 font-medium hover:bg-white hover:text-red-600' onClick={(e)=>handleAddToCart(e,data?._id)}>Add To Cart</button>
                        </div>
